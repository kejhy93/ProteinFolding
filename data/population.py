...
class Population:
    ...
    def generate_candidate_list(self):
        ...
        """
        candidate_list = []
        for candidate in range(SIZE_OF_CANDIDATE_LIST):
    ...
    def find_worst_individuals(self, count):
        ...
        for individual in self.individuals:
            ...
            if exist:
                list_of_index, list_of_values = self.move(list_of_index, list_of_values, index, counter,
                                                          individual.get_free_energy())
    ...
    def __str__(self):
        ...
        res = ""
        for index_of_individual in range(len(self.individuals)):
            res += "Individual " + str(index_of_individual + 1) + ": " + str(
                self.individuals[index_of_individual]) + "\n"
